<section class="articles-all">
    <h2 class="articles-all__title"><?php pll_e('All articles') ?></h2>
    <?php $cat = get_queried_object_id(); ?>
    <?php get_template_part('includes/filter/filter'); ?>
    <?php
            ...
            <div class="article-middle__iitem">
                ...
                <div class="article-info">
                    <figure class="article-info__img">
                        ...
                        <?php global $post;
                        $url = get_avatar_url( $post, "size=126&default=monsterid");
                        ?>
    ...
    <!-- пагинация -->
    <?php get_template_part('includes/pagination/pagination'); ?>
</section>
